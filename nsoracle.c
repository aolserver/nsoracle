...
OracleCmdProc OraclePLSQLObjCommand,
    ...
    OracleLobDMLObjCommand,
    OracleLobDMLBindObjCommand,
    OracleDescObjCommand,
    OracleGetColsObjCommand;
...
static Ns_Set *ora_0or1row(Tcl_Interp * interp, Ns_DbHandle * handle, Ns_Set * row, int *nrows);
 ...
 */
int
OracleObjCommand (ClientData clientData, Tcl_Interp *interp, 
 ...
 */
int
OracleSelectObjCommand (ClientData clientData, Tcl_Interp *interp, 
        int objc, Tcl_Obj *CONST objv[], Ns_DbHandle *dbh)
{
    ora_connection_t  *connection;
    oci_status_t       oci_status;
 ...
 */
int
OracleLobDMLObjCommand (ClientData clientData, Tcl_Interp *interp, 
        int objc, Tcl_Obj *CONST objv[], Ns_DbHandle *dbh)
{
    Tcl_Obj          **data;
    oci_status_t       oci_status;
 ...
 */
int
OracleLobDMLBindObjCommand (ClientData clientData, Tcl_Interp *interp, 
        int objc, Tcl_Obj *CONST objv[], Ns_DbHandle *dbh)
{
    Tcl_Obj          **data;
    oci_status_t       oci_status;
 ...
 */
int
OracleLobSelectObjCommand (ClientData clientData, Tcl_Interp *interp, 
        int objc, Tcl_Obj *CONST objv[], Ns_DbHandle *dbh)
{
    oci_status_t       oci_status;
    ora_connection_t  *connection;
 ...
 */
int
OracleGetColsObjCommand (ClientData clientData, Tcl_Interp *interp, 
        int objc, Tcl_Obj *CONST objv[], Ns_DbHandle *dbh)
{
    ora_connection_t  *connection;
    oci_status_t       oci_status;
 ...
 */
int
OracleResultRowsObjCommand (ClientData clientData, Tcl_Interp *interp, 
        int objc, Tcl_Obj *CONST objv[], Ns_DbHandle *dbh)
{
    ora_connection_t  *connection;
    oci_status_t       oci_status;
    ...
    if (objc != 3) {
        Tcl_AppendResult(interp, "wrong number of args: should be `",
                         Tcl_GetString(objv[0]), " resultrows dbId sql'", NULL);
        return TCL_ERROR;
    }
 ...
 */
int
OracleDescObjCommand (ClientData clientData, Tcl_Interp *interp, 
        int objc, Tcl_Obj *CONST objv[], Ns_DbHandle *dbh)
{
    ora_connection_t  *connection;
    oci_status_t       oci_status;
...
/*
 * AOLserver 3 Plus implementation
 */
